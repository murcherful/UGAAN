...
parser.add_argument('--cate', default='chair', choices=['chair', 'table', 'bookshelf', 'sofa', 'bed', 'pillow', 'cabinet'], help='Category.')
...
'cabinet':3, 'bin':1, 'bag':0}

import torch
from torch.utils.data import Dataset

sys.path.append('./util')
from args_scannet import ARGS_SCANOBJ
from test_util_gan import TestFramework
from my_dataset import USGANDataset_ScanObj, USGANDataset
from io_util import *
